...
import { categories, tints } from '../data.js'
    ...
    <section className="mb-9 grid grid-cols-1 gap-5 sm:grid-cols-3">
      {categories.map((c) => {
        ...
        return (
          ...
          >
            <div className={`grid h-12 w-12 shrink-0 place-items-center rounded-2xl ${tint.bg}`}>
            ...
            <button className="-mr-1 self-start text-muted transition hover:text-ink">
