  ...
  return (
    <section className="relative mb-6 overflow-hidden rounded-card bg-gradient-to-br from-banner-from to-banner-to px-10 py-9 text-white shadow-raised">
      ...
      <h1 className="max-w-xl text-[40px] font-extrabold leading-[1.08]">
        You're {student.hoursLogged} of {student.hoursRequired} hours toward graduation
      </h1>
      <p className="mt-3 max-w-md text-[15px] text-white/80">
        Just {remaining} more hours to go — log a shift or find a local event this week.
      </p>

      <div className="mt-7 flex items-center gap-3">
        <button className="group flex items-center gap-3 rounded-pill bg-ink-button py-3 pl-6 pr-3 text-[15px] font-semibold transition hover:bg-black">
          Log Hours
        ...
        <button className="flex items-center gap-2 rounded-pill bg-white/15 px-6 py-3 text-[15px] font-semibold backdrop-blur transition hover:bg-white/25">
          Find Events
