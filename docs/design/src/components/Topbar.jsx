...
export default function Topbar() {
  return (
    <header className="mb-7 flex items-center gap-4">
      ...
      {/* Icon buttons */}
      <button className="grid h-12 w-12 place-items-center rounded-full bg-surface text-ink shadow-card transition hover:text-primary">
        <Mail size={19} strokeWidth={2.2} />
      </button>
      <button className="relative grid h-12 w-12 place-items-center rounded-full bg-surface text-ink shadow-card transition hover:text-primary">
