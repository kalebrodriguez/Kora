...
import { student, organizations } from '../data.js'
    ...
    <aside className="sticky top-0 hidden h-screen w-[372px] shrink-0 overflow-y-auto px-6 py-7 xl:block">
      <div className="flex flex-col gap-6 rounded-card bg-surface p-6 shadow-card">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="text-muted transition hover:text-ink">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-[13px] text-muted">
            {student.streakWeeks}-week streak — {student.hoursRequired - student.hoursLogged} hours
            left to graduate.
          </p>
        </div>
      ...
      <div className="mt-6 rounded-card bg-surface p-6 shadow-card">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button className="grid h-7 w-7 place-items-center rounded-full bg-accent-lavender text-primary transition hover:bg-primary hover:text-white">
          ...
          {organizations.map((o, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {following ? <Check size={15} strokeWidth={2.6} /> : <UserPlus size={15} strokeWidth={2.4} />}
        ...
        <button className="mt-4 w-full rounded-chip bg-accent-lavender py-3 text-[14px] font-semibold text-primary transition hover:bg-primary hover:text-white">
          See All
        </button>
      </div>
    </aside>
